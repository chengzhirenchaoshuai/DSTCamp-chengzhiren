...
STRINGS = {
    "zh": {
        ...
        "selfhost.lobby_accel_hint": "仅将饥荒专用服务器的 TCP 流量经 Mihomo TUN、本地 SOCKS5 和现有 SSH 连接从自建 frps 服务器发出；UDP 游戏流量仍由 frp 转发。需以管理员身份运行 DSTCamp。",
        ...
        "selfhost.lobby_accel_status_starting": "正在建立 SSH/TUN 链路...",
    ...
    "en": {
        ...
        "selfhost.lobby_accel_hint": "Routes only DST dedicated-server TCP through Mihomo TUN, a local SOCKS5 gateway, and the existing SSH connection so it exits from the self-hosted frps server. UDP game traffic still uses frp. DSTCamp must run as administrator.",
        ...
        "selfhost.lobby_accel_status_starting": "Establishing SSH/TUN route...",
