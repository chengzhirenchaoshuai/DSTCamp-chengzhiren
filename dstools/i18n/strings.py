...
STRINGS = {
    "zh": {
        ...
        "mod.scan_found_with_missing": "已发现{regular}个模组，{custom}个自定义模组；当前世界另有{missing}个已启用模组未安装",
    ...
    "en": {
        ...
        "mod.scan_found_with_missing": "Found {regular} mods and {custom} custom mods; {missing} enabled mod(s) referenced by this shard are not installed",
