...
STRINGS = {
    "zh": {
        ...
        "settings.cache_dir_non_ascii": "所选路径包含中文或其他非 ASCII 字符，旧版图标转换工具无法在该路径运行。\n\n请选择纯英文的本地路径，例如 D:\\DSTCampData\\cache。\n\n当前路径：{path}",
    ...
    "en": {
        ...
        "settings.cache_dir_non_ascii": "The selected path contains non-ASCII characters, so the legacy icon converter cannot run there.\n\nChoose a local ASCII-only path such as D:\\DSTCampData\\cache.\n\nCurrent path: {path}",
