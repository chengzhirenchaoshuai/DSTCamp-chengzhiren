...
STRINGS = {
    "zh": {
        ...
        "local.wegame_detect_placeholder": "点击上方按钮，检测这个存档的分片进程是否真的在跑。",
        ...
        "local.luajit_blocked_running": "该安装目录下有分片正在运行，请先停止再操作",
        ...
        "local.luajit_log_mod_enabled": "已在 {n} 个分片启用创意工坊配套 Mod",
