...
STRINGS = {
    "zh": {
        ...
        "selfhost.token_hint": "frps 和 frpc 互相验证身份用的密钥，双方必须完全一致，防止别人拿你公开的服务器地址冒充客户端建隧道。不建议手动改成好记的弱口令；需要换一个就用旁边「重新生成Token」按钮。",
